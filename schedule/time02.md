...
- 09:15-09:45 Data, models, and science ((reiner))
...
- 09:45-10:00 Working with the DAIDD technical tools ((hladish), [Faikah Bruce]({{site.subdomainurl}}/team/bruce/)) 
	* 
	* ICI3D R package
...
- 08:30-08:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ((deleo))
	* 
...
- 11:30-12:00 Discussion: Dynamical Fever ((vs)) 
...
- 09:45-10:30 Live lecture: The simplest model ((hladish)) 

#### Interactive session 3b ((reiner))



- 11:30-12:00 Exercise: Simple individual-based models ((hladish)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 12:00-13:30 Exercise: Creating a model world to address a research question ((vs)) 
...
- 11:45-12:30 Tutorial: Heterogeneity in disease emergence ((reiner), (li), [Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	 * 
...
- 08:30-08:50 Regroup after feedback ((vs)) 
...
- 08:30-08:45 Daily recap ((mentors)) 
- 08:45-10:30 Discussion of research plans/proposals (Moderator: (vs))
