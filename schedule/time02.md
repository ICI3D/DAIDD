...
- 08:30-08:45 Daily recap ((__tbd__)) 
...
- 09:45-10:30 Live lecture: The simplest model ((__tbd__)) 

#### Interactive session 3b



- 11:30-12:00 Exercise: Simple individual-based models ((__tbd__)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 08:50-09:05 Daily recap ((__tbd__)) 
- 09:05-09:20 Summary and discussion: Models and data: introduction to model fitting ((__tbd__)) 
...
- 09:00-10:30 Live lecture: Use of models in public health decision-making (Faculty research presentation) - Now with more COVID! ((__tbd__)) 
...
**_Special session:_ 14:00-15:30**
