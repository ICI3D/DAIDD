...
- 06:30-06:45 Daily recap ((__tbd__)) 
...
- 07:45-08:30 Live lecture: The simplest model ((__tbd__)) 

#### Interactive session 3b



- 09:30-10:00 Exercise: Simple individual-based models ((__tbd__)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 06:50-07:05 Daily recap ((__tbd__)) 
- 07:05-07:20 Summary and discussion: Models and data: introduction to model fitting ((__tbd__)) 
...
- 07:00-08:30 Live lecture: Use of models in public health decision-making (Faculty research presentation) - Now with more COVID! ((__tbd__)) 
