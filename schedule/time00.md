...
- 07:15-07:45 Data, models, and science ((reiner))
...
- 07:45-08:00 Working with the DAIDD technical tools ((hladish), [Faikah Bruce]({{site.subdomainurl}}/team/bruce/)) 
	* 
	* ICI3D R package
...
- 06:30-06:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ((deleo))
	* 
...
- 09:30-10:00 Discussion: Dynamical Fever ((vs)) 
...
- 07:45-08:30 Live lecture: The simplest model ((hladish)) 

#### Interactive session 3b ((reiner))



- 09:30-10:00 Exercise: Simple individual-based models ((hladish)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 10:00-11:30 Exercise: Creating a model world to address a research question ((vs)) 
...
- 09:45-10:30 Tutorial: Heterogeneity in disease emergence ((reiner), (li), [Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	 * 
...
- 06:30-06:50 Regroup after feedback ((vs)) 
...
- 06:30-06:45 Daily recap ((mentors)) 
- 06:45-08:30 Discussion of research plans/proposals (Moderator: (vs))
