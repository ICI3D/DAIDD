...
- 21:45-22:00 Working with the DAIDD technical tools ((__tbd__)) 
...
- 23:30-01:30 Research pitches (Moderator: (__tbd__))
...
- 20:30-20:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ((__tbd__))
...
- 21:00-22:30 Tutorial: Dynamical Fever - computer exercise and discussion ((__tbd__) and all faculty) 
...
- 23:30-00:00 Discussion: Dynamical Fever ((__tbd__)) 
...
- 20:30-20:45 Daily recap ((__tbd__)) 
...
- 21:45-22:30 Live lecture: The simplest model ((__tbd__)) 

#### Interactive session 3b



- 23:30-00:00 Exercise: Simple individual-based models ((__tbd__)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 00:00-01:30 Exercise: Creating a model world to address a research question ((__tbd__)) 
...
- 20:45-21:00 Summary and discussion: Stochastic simulation models ((__tbd__)) 
...
- 23:45-00:30 Tutorial: Heterogeneity in disease emergence ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/), (__tbd__), (li)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 20:50-21:05 Daily recap ((__tbd__)) 
- 21:05-21:20 Summary and discussion: Models and data: introduction to model fitting ((__tbd__)) 
...
- 21:00-22:30 Live lecture: Use of models in public health decision-making (Faculty research presentation) - Now with more COVID! ((__tbd__)) 
