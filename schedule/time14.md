...
- 20:30-20:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ([Becky Borchering]({{site.subdomainurl}}/team/borchering/))
...
- 21:00-22:30 Tutorial: Dynamical Fever - computer exercise and discussion ([Larisse Bolton]({{site.subdomainurl}}/team/bolton/) and all faculty) 
...
- 23:30-00:00 Discussion: Dynamical Fever ([Larisse Bolton]({{site.subdomainurl}}/team/bolton/)) 
...
- 21:45-22:30 Live lecture: The simplest model ([Carl Pearson]({{site.subdomainurl}}/team/pearson/)) 
...
- 00:00-01:30 Exercise: Creating a model world to address a research question ((mwangi)) 
...
- 23:45-00:30 Tutorial: Heterogeneity in disease emergence ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/), [Carl Pearson]({{site.subdomainurl}}/team/pearson/), (li)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 20:50-21:05 Daily recap ((mwangi)) 
- 21:05-21:20 Summary and discussion: Models and data: introduction to model fitting ([Larisse Bolton]({{site.subdomainurl}}/team/bolton/)) 
- 21:20-22:30 Writing exercise: description of proposed model and assumptions ((reiner)) 
...
- 20:30-20:45 Daily recap ((reiner)) 
...
- 00:00-00:30 Review and Discussion (Moderator: (mwangi)) 
