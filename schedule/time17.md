...
- 00:45-01:30 Live lecture: The simplest model ((hladish)) 

#### Interactive session 3b ((reiner))



- 02:30-03:00 Exercise: Simple individual-based models ((hladish)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 23:30-23:45 Daily recap ((mentors)) 
...
- 23:30-23:50 Regroup after feedback ((vs)) 
- 23:50-00:05 Daily recap ((mentors)) 
...
**_Special session (NA)_ 05:00-06:30**
...
**_Special session (Africa)_ 19:00-20:30**
...
- 23:30-23:45 Daily recap ((mentors)) 
- 23:45-01:30 Discussion of research plans/proposals (Moderator: (vs))
