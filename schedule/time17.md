...
- 23:30-23:45 Welcome and some logistics ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/))
- 23:45-00:10 What are we doing here? ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/)) 
- 00:15-00:45 Data, models, and science ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
...
- 00:45-01:00 Working with the DAIDD technical tools ([Carl Pearson]({{site.subdomainurl}}/team/pearson/)) 
...
- 02:30-04:30 Research pitches (Moderator: [Becky Borchering]({{site.subdomainurl}}/team/borchering/))
...
- 18:00 Tea with African Faculty
    - 17:30 (optional)
...
- 23:30-23:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ([Becky Borchering]({{site.subdomainurl}}/team/borchering/))
...
- 00:00-01:30 Tutorial: Dynamical Fever - computer exercise and discussion ([Larisse Bolton]({{site.subdomainurl}}/team/bolton/) and all faculty) 
...
- 02:30-03:00 Discussion: Dynamical Fever ([Larisse Bolton]({{site.subdomainurl}}/team/bolton/)) 
...
- 23:30-23:45 Daily recap ([Becky Borchering]({{site.subdomainurl}}/team/borchering/)) 
...
- 00:30-00:45 Summary and discussion: The life cycle of a modeling project ((reiner))
- 00:45-01:30 Live lecture: The simplest model ([Carl Pearson]({{site.subdomainurl}}/team/pearson/)) 

#### Interactive session 3b



- 02:30-03:00 Exercise: Simple individual-based models ([Carl Pearson]({{site.subdomainurl}}/team/pearson/)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 03:00-04:30 Exercise: Creating a model world to address a research question ((mwangi)) 
...
- 23:45-00:00 Summary and discussion: Stochastic simulation models ([Becky Borchering]({{site.subdomainurl}}/team/borchering/)) 
...
- 02:45-03:30 Tutorial: Heterogeneity in disease emergence ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/), [Carl Pearson]({{site.subdomainurl}}/team/pearson/), (li)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 03:30-04:30 Mid-session feedback ([Faikah Bruce]({{site.subdomainurl}}/team/bruce/)) 
...
- 07:30 Tea with North American Faculty
- 20:00 Tea with African Faculty
...
- 23:50-00:05 Daily recap ((mwangi)) 
- 00:05-00:20 Summary and discussion: Models and data: introduction to model fitting ([Larisse Bolton]({{site.subdomainurl}}/team/bolton/)) 
...
- 04:00-04:30 Review: model taxonomy ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/)) 
...
- 23:30-23:45 Daily recap ((reiner)) 
- 23:45-00:00 Summary and discussion: Model evaluation and comparison ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
- 00:00-01:30 Live lecture: Use of models in public health decision-making (Faculty research presentation) - Now with more COVID! ([Carl Pearson]({{site.subdomainurl}}/team/pearson/)) 

#### Interactive session 6b


- 02:30-03:00 Live lecture: Model-based inference and the bigger picture ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
	* [Slides (by Bellan)](https://github.com/dushoff/statistics_talks/blob/master/outputs/inference2020.pdf)
- 03:00-03:30 Review and Discussion (Moderator: (mwangi)) 
...
**_Special session:_ 05:30-06:30**
...
**_Special session:_ 19:00-20:30**
...
- 23:30-23:45 Daily recap ((li)) 
- 23:45-01:30 Discussion of research plans/proposals (Moderator: [Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))

#### Interactive session 7b

- 02:30-04:00 Final feedback session ([Faikah Bruce]({{site.subdomainurl}}/team/bruce/)) 
- 04:00-04:15 Closing session ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/)) 
