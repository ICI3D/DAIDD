...
- 23:15-23:45 Data, models, and science ((reiner))
...
- 23:45-00:00 Working with the DAIDD technical tools ((hladish), [Faikah Bruce]({{site.subdomainurl}}/team/bruce/)) 
	* 
	* ICI3D R package
...
- 22:30-22:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ((deleo))
	* 
...
- 01:30-02:00 Discussion: Dynamical Fever ((vs)) 
...
- 23:45-00:30 Live lecture: The simplest model ((hladish)) 

#### Interactive session 3b ((reiner))



- 01:30-02:00 Exercise: Simple individual-based models ((hladish)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 02:00-03:30 Exercise: Creating a model world to address a research question ((vs)) 
...
- 01:45-02:30 Tutorial: Heterogeneity in disease emergence ((reiner), (li), [Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	 * 
...
- 22:30-22:50 Regroup after feedback ((vs)) 
...
- 22:30-22:45 Daily recap ((mentors)) 
- 22:45-00:30 Discussion of research plans/proposals (Moderator: (vs))
