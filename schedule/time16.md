...
- 22:30-22:45 Daily recap ((__tbd__)) 
...
- 23:45-00:30 Live lecture: The simplest model ((__tbd__)) 

#### Interactive session 3b



- 01:30-02:00 Exercise: Simple individual-based models ((__tbd__)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 02:00-03:30 Exercise: Creating a model world to address a research question ((__tbd__)) 
...
- 22:45-23:00 Summary and discussion: Stochastic simulation models ((__tbd__)) 
...
- 01:45-02:30 Tutorial: Heterogeneity in disease emergence ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/), (__tbd__), (li)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 22:50-23:05 Daily recap ((__tbd__)) 
- 23:05-23:20 Summary and discussion: Models and data: introduction to model fitting ((__tbd__)) 
...
- 23:00-00:30 Live lecture: Use of models in public health decision-making (Faculty research presentation) - Now with more COVID! ((__tbd__)) 
