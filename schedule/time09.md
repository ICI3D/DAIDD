...
- 16:15-16:45 Data, models, and science ((reiner))
...
- 16:45-17:00 Working with the DAIDD technical tools ((hladish), [Faikah Bruce]({{site.subdomainurl}}/team/bruce/)) 
	* 
	* ICI3D R package
...
- 15:30-15:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ((deleo))
	* 
...
- 18:30-19:00 Discussion: Dynamical Fever ((vs)) 
...
- 16:45-17:30 Live lecture: The simplest model ((hladish)) 

#### Interactive session 3b ((reiner))



- 18:30-19:00 Exercise: Simple individual-based models ((hladish)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 19:00-20:30 Exercise: Creating a model world to address a research question ((vs)) 
...
- 18:45-19:30 Tutorial: Heterogeneity in disease emergence ((reiner), (li), [Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	 * 
...
- 15:30-15:50 Regroup after feedback ((vs)) 
...
- 15:30-15:45 Daily recap ((mentors)) 
- 15:45-17:30 Discussion of research plans/proposals (Moderator: (vs))
