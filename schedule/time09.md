...
- 15:30-15:45 Welcome and some logistics ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
- 15:45-16:10 What are we doing here? ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/)) 
- 16:15-16:45 Data, models, and science ([Bobby Reiner]({{site.subdomainurl}}/team/reiner/))
- 16:45-17:00 Working with the DAIDD technical tools ([Tom Hladish]({{site.subdomainurl}}/team/hladish/), [Faikah Bruce]({{site.subdomainurl}}/team/bruce/)) 
	* ICI3D R package
...
- 15:30-15:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ([Giulio De Leo]({{site.subdomainurl}}/team/deleo/))
- 15:50-16:00 [Overview of research plan development and structure](https://www.dropbox.com/s/5lojjt5yqjsw668/DAIDD2022guide.pdf?dl=1) ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/)) 
- 16:00-17:30 Tutorial: Dynamical Fever - computer exercise and discussion ([Michael Li]({{site.subdomainurl}}/team/li/) and all faculty)
...
- 18:30-19:00 Discussion: Dynamical Fever ([Cari van Schalkwyk]({{site.subdomainurl}}/team/vanschalkwyk/)) 
...
- 16:30-16:45 Summary and discussion: The life cycle of a modeling project ([Bobby Reiner]({{site.subdomainurl}}/team/reiner/))
- 16:45-17:30 Live lecture: The simplest model ([Tom Hladish]({{site.subdomainurl}}/team/hladish/)) 

#### Interactive session 3b ([Bobby Reiner]({{site.subdomainurl}}/team/reiner/))


- 18:30-19:15 Exercise: Simple individual-based models ([Tom Hladish]({{site.subdomainurl}}/team/hladish/)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 19:15-20:30 Exercise: Creating a model world to address a research question ([Cari van Schalkwyk]({{site.subdomainurl}}/team/vanschalkwyk/)) 
...
- 15:30-15:45 Daily recap (__Lauren Brown__) 
- 15:45-16:00 Summary and discussion: Stochastic simulation models ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
- 16:00-17:30 Small-group session: matching model worlds to questions (All faculty) 

#### Interactive session 4b ([Giulio De Leo]({{site.subdomainurl}}/team/deleo/))


- 18:30-18:45 Summary and discussion: Impact of contact patterns, consequences of heterogeneity, and modeling options ([Tom Hladish]({{site.subdomainurl}}/team/hladish/)) 
- 18:45-19:30 Tutorial: Heterogeneity in disease emergence ([Bobby Reiner]({{site.subdomainurl}}/team/reiner/), [Michael Li]({{site.subdomainurl}}/team/li/), [Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/), [Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 15:30-15:50 Regroup after feedback ([Cari van Schalkwyk]({{site.subdomainurl}}/team/vanschalkwyk/)) 
- 15:50-16:05 Daily recap (__Elisha Are__) 
- 16:05-16:20 Summary and discussion: Models and data: introduction to model fitting ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
...
- 18:30-20:00 Tutorial: Model fitting ([Michael Li]({{site.subdomainurl}}/team/li/)) 
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 16:00-17:30 Live lecture: Use of models in public health decision-making (Faculty research presentation)((__tbd__))
...
**_Special session_ (North America) 21:00-22:30**
...
**_Special session_ (Africa) 11:00-12:30**

- One-on-one mentoring sessions 

#### Interactive session 7a

- 15:30-15:45 Daily recap (__Elisha Are__) 
- 15:45-17:30 Discussion of research plans/proposals (Moderator: [Cari van Schalkwyk]({{site.subdomainurl}}/team/vanschalkwyk/))

#### Interactive session 7b

- 18:30-20:00 Final feedback session ([Faikah Bruce]({{site.subdomainurl}}/team/bruce/)) 
- 20:00-20:15 Closing session ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
