...
- 16:30-16:45 Daily recap ((__tbd__)) 
...
- 17:45-18:30 Live lecture: The simplest model ((__tbd__)) 

#### Interactive session 3b



- 19:30-20:00 Exercise: Simple individual-based models ((__tbd__)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 20:00-21:30 Exercise: Creating a model world to address a research question ((__tbd__)) 
...
- 16:45-17:00 Summary and discussion: Stochastic simulation models ((__tbd__)) 
...
- 19:45-20:30 Tutorial: Heterogeneity in disease emergence ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/), (__tbd__), (li)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 16:50-17:05 Daily recap ((__tbd__)) 
- 17:05-17:20 Summary and discussion: Models and data: introduction to model fitting ((__tbd__)) 
...
- 17:00-18:30 Live lecture: Use of models in public health decision-making (Faculty research presentation) - Now with more COVID! ((__tbd__)) 
...
- 20:00-20:30 Review and Discussion (Moderator: (__tbd__)) 
