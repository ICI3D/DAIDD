...
- 10:15-10:45 Data, models, and science ((reiner))
...
- 10:45-11:00 Working with the DAIDD technical tools ((hladish), [Faikah Bruce]({{site.subdomainurl}}/team/bruce/)) 
	* 
	* ICI3D R package
...
- 09:30-09:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ((deleo))
	* 
...
- 10:00-11:30 Tutorial: Dynamical Fever - computer exercise and discussion ((li) and all faculty) 
	* 
	* 
...
- 12:30-13:00 Discussion: Dynamical Fever ((vs)) 
...
- 09:30-09:45 Daily recap ((__tbd__)) 
...
- 10:30-10:45 Summary and discussion: The life cycle of a modeling project ((reiner))
- 10:45-11:30 Live lecture: The simplest model ((__tbd__)) 

#### Interactive session 3b



- 12:30-13:00 Exercise: Simple individual-based models ((__tbd__)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 13:00-14:30 Exercise: Creating a model world to address a research question ((__tbd__)) 
...
- 09:30-09:45 Daily recap ((li)) 
- 09:45-10:00 Summary and discussion: Stochastic simulation models ((__tbd__)) 
...
- 12:45-13:30 Tutorial: Heterogeneity in disease emergence ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/), (__tbd__), (li)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 17:30 Tea with North American Faculty
- 06:00 Tea with African Faculty
...
- 09:50-10:05 Daily recap ((__tbd__)) 
- 10:05-10:20 Summary and discussion: Models and data: introduction to model fitting ((__tbd__)) 
- 10:20-11:30 Writing exercise: description of proposed model and assumptions ((reiner)) 

#### Interactive session 5b



- 12:30-14:00 Tutorial: Model fitting ((li)) 
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 09:30-09:45 Daily recap ((reiner)) 
- 09:45-10:00 Summary and discussion: Model evaluation and comparison ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
- 10:00-11:30 Live lecture: Use of models in public health decision-making (Faculty research presentation) - Now with more COVID! ((__tbd__)) 
...
**_Special session:_ 15:00-16:30**
