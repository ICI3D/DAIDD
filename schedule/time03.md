...
- 10:45-11:30 Live lecture: The simplest model ((hladish)) 

#### Interactive session 3b ((reiner))



- 12:30-13:00 Exercise: Simple individual-based models ((hladish)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 09:30-09:45 Daily recap ((mentors)) 
...
- 09:30-09:50 Regroup after feedback ((vs)) 
- 09:50-10:05 Daily recap ((mentors)) 
...
**_Special session (NA)_ 15:00-16:30**
...
**_Special session (Africa)_ 05:00-06:30**
...
- 09:30-09:45 Daily recap ((mentors)) 
- 09:45-11:30 Discussion of research plans/proposals (Moderator: (vs))
