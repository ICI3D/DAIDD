...
- 10:30-11:15 Exercise: Simple individual-based models ([Tom Hladish]({{site.subdomainurl}}/team/hladish/)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 11:15-12:30 Exercise: Creating a model world to address a research question ([Cari van Schalkwyk]({{site.subdomainurl}}/team/vanschalkwyk/)) 
...
- 07:50-08:05 Daily recap ([Elisha Are]({{site.subdomainurl}}/team/are/)) 
...
- 10:30-12:00 Tutorial: Model fitting ([Michael Li]({{site.subdomainurl}}/team/li/)) 
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 08:00-09:30 Live lecture: Use of models in public health decision-making (Faculty research presentation)
...
- 10:30-11:00 Live lecture: Model-based inference and the bigger picture ((__tbd__)) 
	* WAS dushoff
...
**_Special session_ (North America) 13:00-14:30**
...
**_Special session_ (Africa) 03:00-04:30**

- One-on-one mentoring sessions 

#### Interactive session 7a

- 07:30-07:45 Daily recap ([Elisha Are]({{site.subdomainurl}}/team/are/)) 
...
- 12:00-12:15 Closing session ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
