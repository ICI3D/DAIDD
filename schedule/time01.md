...
- 08:45-09:00 Working with the DAIDD technical tools ((__tbd__)) 
...
- 10:30-12:30 Research pitches (Moderator: (__tbd__))
...
- 07:30-07:50 Summary and questions: Intuitive aspects of dynamics and introduction to model worlds ((__tbd__))
...
- 08:00-09:30 Tutorial: Dynamical Fever - computer exercise and discussion ((__tbd__) and all faculty) 
...
- 10:30-11:00 Discussion: Dynamical Fever ((__tbd__)) 
...
- 07:30-07:45 Daily recap ((__tbd__)) 
...
- 08:45-09:30 Live lecture: The simplest model ((__tbd__)) 

#### Interactive session 3b



- 10:30-11:00 Exercise: Simple individual-based models ((__tbd__)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 11:00-12:30 Exercise: Creating a model world to address a research question ((__tbd__)) 
...
- 07:45-08:00 Summary and discussion: Stochastic simulation models ((__tbd__)) 
...
- 10:45-11:30 Tutorial: Heterogeneity in disease emergence ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/), (__tbd__), (li)) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
...
- 07:50-08:05 Daily recap ((__tbd__)) 
- 08:05-08:20 Summary and discussion: Models and data: introduction to model fitting ((__tbd__)) 
...
- 08:00-09:30 Live lecture: Use of models in public health decision-making (Faculty research presentation) - Now with more COVID! ((__tbd__)) 
...
- 11:00-11:30 Review and Discussion (Moderator: (__tbd__)) 
